...
from afkbot.cli.commands.chat_planning_runtime import render_captured_plan
from afkbot.cli.commands.chat_session_runtime import _run_repl_turn
...
async def test_run_repl_turn_keeps_plan_confirm_in_plan_on_mode() -> None:
    """Explicit REPL plan-first mode should keep execution confirmation without a dead pre-plan hook."""
