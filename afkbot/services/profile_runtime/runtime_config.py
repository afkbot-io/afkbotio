...
class ProfileRuntimeConfigService:
    ...
    def resolved_runtime(settings: Settings) -> ProfileRuntimeResolved:
        ...
        return ProfileRuntimeResolved(
            ...
            memory_core_enabled=settings.memory_core_enabled,
            memory_core_max_items=settings.memory_core_max_items,
            memory_core_max_chars=settings.memory_core_max_chars,
