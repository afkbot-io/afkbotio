...
_EXPORTS: dict[str, tuple[str, str]] = {
    "ProfileBootstrapFileView": (
        "afkbot.services.profile_runtime.contracts",
        "ProfileBootstrapFileView",
    ),
    ...
    "ProfileBootstrapService": (
        "afkbot.services.profile_runtime.bootstrap_service",
        "ProfileBootstrapService",
    ),
    ...
    "reset_profile_bootstrap_services": (
        "afkbot.services.profile_runtime.bootstrap_service",
        "reset_profile_bootstrap_services",
    ),
    "ProfileRuntimeConfigService": (
        "afkbot.services.profile_runtime.runtime_config",
        "ProfileRuntimeConfigService",
    ),
    ...
    "reset_profile_runtime_config_services": (
        "afkbot.services.profile_runtime.runtime_config",
        "reset_profile_runtime_config_services",
    ),
    "ProfileRuntimeSecretsService": (
        "afkbot.services.profile_runtime.runtime_secrets",
        "ProfileRuntimeSecretsService",
    ),
    ...
    "reset_profile_runtime_secrets_services": (
        "afkbot.services.profile_runtime.runtime_secrets",
        "reset_profile_runtime_secrets_services",
    ),
    ...
    "run_profile_service_sync": (
        "afkbot.services.profile_runtime.service",
        "run_profile_service_sync",
    ),
