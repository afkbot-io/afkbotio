...
def build_agent_loop_from_settings(
    ...
    *,
    ...
    return AgentLoop(
        ...
        memory_core_enabled=effective_settings.memory_core_enabled,
        memory_core_max_items=effective_settings.memory_core_max_items,
        memory_core_max_chars=effective_settings.memory_core_max_chars,
