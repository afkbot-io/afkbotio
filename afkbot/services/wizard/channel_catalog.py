...
def channel_plan(transport: str) -> WizardPlan:
    ...
    questions = [
        ...
        _question(
            ...
            "runtime",
            "integer",
            "Pause after each merged turn (sec)",
            "Пауза после каждого объединённого хода (сек)",
            shown_when="ingress_batch",
        ),
        _question(
            ...
            "runtime",
            "integer",
            "Maximum messages per merged turn",
            "Максимум сообщений в одном объединённом ходе",
            shown_when="ingress_batch",
        ),
        _question(
            ...
            "runtime",
            "integer",
            "Maximum merged text size (chars)",
            "Максимальный размер объединённого текста (символы)",
            shown_when="ingress_batch",
        ),
    ]
    if normalized == "telegram":
        questions.extend(
            (
                ...
                _question(
                    ...
                    "runtime",
                    "confirm",
                    "Make replies look more natural?",
                    "Делать ответы более похожими на живую переписку?",
                ),
                _question(
                    "humanize_min_delay",
                    "runtime",
                    "integer",
                    "Minimum reply delay (ms)",
                    "Минимальная задержка ответа (мс)",
                    shown_when="humanize_replies",
                ),
                _question(
                    "humanize_max_delay",
                    "runtime",
                    "integer",
                    "Maximum reply delay (ms)",
                    "Максимальная задержка ответа (мс)",
                    shown_when="humanize_replies",
                ),
                _question(
        ...
        questions.extend(
            (
                ...
                _question(
                    "telethon_reply_blocked_chat_patterns",
                    "transport",
                    "text",
                    "Blocked reply chat patterns",
                    "Шаблоны чатов без ответов",
                    advanced=True,
                ),
                _question(
                    "telethon_reply_allowed_chat_patterns",
                    "transport",
                    "text",
                    "Allowed reply chat patterns",
                    "Шаблоны чатов с ответами",
                    advanced=True,
                ),
                _question(
                    "telethon_mark_read_before_reply",
                    "runtime",
                    "confirm",
                    "Mark chat as read before reply?",
                    "Отмечать чат прочитанным перед ответом?",
                ),
                _question(
                    "humanize_replies",
                    "runtime",
                ...
                _question(
                    "telethon_watcher_unmuted_only",
                    "watcher",
                    "confirm",
                    "Watch only dialogs with notifications on?",
                    "Следить только за диалогами с включёнными уведомлениями?",
                    shown_when="telethon_watcher_digest",
                ),
                _question(
                    "telethon_watcher_include_private",
                    "watcher",
                    "confirm",
                    "Include private chats in digests?",
                    "Включать личные чаты в дайджесты?",
                    shown_when="telethon_watcher_digest",
                ),
                _question(
                    "telethon_watcher_include_groups",
                    "watcher",
                    "confirm",
                    "Include groups in digests?",
                    "Включать группы в дайджесты?",
                    shown_when="telethon_watcher_digest",
                ),
                _question(
                    "telethon_watcher_include_channels",
                    "watcher",
                    "confirm",
                    "Include Telegram channels in digests?",
                    "Включать Telegram-каналы в дайджесты?",
                    shown_when="telethon_watcher_digest",
                ),
                _question(
                    "telethon_watcher_batch_interval",
                    "watcher",
                    "integer",
                    "Digest interval (sec)",
                    "Интервал дайджеста (сек)",
                    shown_when="telethon_watcher_digest",
                ),
                _question(
                    "telethon_watcher_dialog_refresh_interval",
                    "watcher",
                    "integer",
                    "Dialog metadata refresh interval (sec)",
                    "Интервал обновления данных диалогов (сек)",
                    shown_when="telethon_watcher_digest",
                ),
                _question(
                    "telethon_watcher_max_batch_size",
                    "watcher",
                    "integer",
                    "Maximum events per digest",
                    "Максимум событий в одном дайджесте",
                    shown_when="telethon_watcher_digest",
                ),
                _question(
                    "telethon_watcher_max_buffer_size",
                    "watcher",
                    "integer",
                    "Maximum watcher backlog",
                    "Максимальный backlog наблюдателя",
                    shown_when="telethon_watcher_digest",
                ),
                _question(
                    "telethon_watcher_max_message_chars",
                    "watcher",
                    "integer",
                    "Maximum characters per watched message",
                    "Максимум символов на одно наблюдаемое сообщение",
                    shown_when="telethon_watcher_digest",
                ),
                _question(
                    "telethon_watcher_blocked_chat_patterns",
                    "watcher",
                    "text",
                    "Blocked watcher chat patterns",
                    "Шаблоны чатов вне наблюдения",
                    shown_when="telethon_watcher_digest",
                    advanced=True,
                ),
                _question(
                    "telethon_watcher_allowed_chat_patterns",
                    "watcher",
                    "text",
                    "Allowed watcher chat patterns",
                    "Шаблоны наблюдаемых чатов",
                    shown_when="telethon_watcher_digest",
                    advanced=True,
                ),
                _question(
                    "telethon_watcher_delivery_transport",
                    "watcher",
                    "single",
                    "Watcher delivery transport",
                    "Транспорт доставки дайджеста",
                    shown_when="telethon_watcher_digest",
                    advanced=True,
                ),
                _question(
                    "telethon_watcher_delivery_account_id",
                    "watcher",
                    "text",
                    "Watcher delivery account id",
                    "Аккаунт доставки дайджеста",
                    shown_when="telethon_watcher_digest",
                    advanced=True,
                ),
                _question(
                    "telethon_watcher_delivery_peer_id",
                    "watcher",
                    "text",
                ...
                _question(
                    "telethon_watcher_delivery_credential_profile_key",
                    "watcher",
                    "text",
                    "Watcher delivery credential profile",
                    "Профиль учётных данных доставки",
                    shown_when="telethon_watcher_digest",
                    advanced=True,
                ),
                _question(
    ...
    if normalized in {"telegram", "telethon"}:
        branches.append(
            _branch(
                "reply_humanization",
                "humanize_replies",
    ...
    if normalized == "telethon":
        branches.append(
            _branch(
                ...
                "Telethon watcher digest",
                "Дайджест наблюдателя Telethon",
            )
        )
    return WizardPlan(
