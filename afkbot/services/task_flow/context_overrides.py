...
def _build_task_flow_prompt_overlay(
    *,
    ...
    lines = [
        ...
        "When the current task needs help from another specialist, prefer task.delegate to create a self-contained task for another ai_profile agent and leave a durable handoff trail.",
