...
_MODEL_EXPORT_MODULES = {
    ...
    "TaskBudgetIncident": "task_budget_incident",
    "TaskBudgetPolicy": "task_budget_policy",
    "TaskContextDigest": "task_context_digest",
    "TaskDelegationClaim": "task_delegation_claim",
    ...
    "TaskRecoveryAction": "task_recovery_action",
